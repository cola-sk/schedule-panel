...
import { reviewItem } from "@/lib/knowledge-migration/service";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export async function PATCH(request: Request, context: RouteContext<"/api/knowledge-migrations/items/[id]">) {
  try {
    ...
    const item = reviewItem({
      ...
      action: body.action === "skip" || body.action === "reset" ? body.action : "save",
